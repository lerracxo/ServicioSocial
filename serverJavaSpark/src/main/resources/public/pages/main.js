var app = angular.module('codecraft',  ['ngRoute']);
...
app.config([ '$routeProvider', '$locationProvider',
    function($routeProvider, $locationProvider) {
        ...
        $routeProvider.when('/detail/:databaseName', {
            templateUrl : '/pages/detail.html',
            controller : 'databaseDetails'
        })
// .otherwise({
...
app.controller('PersonsController',['$scope','$http','$location','$routeParams', function ($scope,$http,$location,$routeParams) {
